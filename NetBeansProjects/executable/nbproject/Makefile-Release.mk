...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/executable: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/executable ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/_ext/8a836532/main.o: ../../Bureau/TR/superviseur_robot-master/destijl_init/main.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/8a836532
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8a836532/main.o ../../Bureau/TR/superviseur_robot-master/destijl_init/main.cpp
...
${OBJECTDIR}/_ext/23209787/functions.o: ../../Bureau/TR/superviseur_robot-master/destijl_init/src/functions.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/23209787/functions.o ../../Bureau/TR/superviseur_robot-master/destijl_init/src/functions.cpp

${OBJECTDIR}/_ext/137e0538/image.o: ../../Bureau/TR/superviseur_robot-master/src/image.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/137e0538
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/137e0538/image.o ../../Bureau/TR/superviseur_robot-master/src/image.cpp

${OBJECTDIR}/_ext/137e0538/message.o: ../../Bureau/TR/superviseur_robot-master/src/message.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/137e0538
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/137e0538/message.o ../../Bureau/TR/superviseur_robot-master/src/message.cpp

${OBJECTDIR}/_ext/137e0538/monitor.o: ../../Bureau/TR/superviseur_robot-master/src/monitor.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/137e0538
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/137e0538/monitor.o ../../Bureau/TR/superviseur_robot-master/src/monitor.cpp

${OBJECTDIR}/_ext/137e0538/robot.o: ../../Bureau/TR/superviseur_robot-master/src/robot.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/137e0538
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/137e0538/robot.o ../../Bureau/TR/superviseur_robot-master/src/robot.cpp
